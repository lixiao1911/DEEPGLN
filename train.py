...
def load_dataset(val_ratio):
    ...
    train_DB, valid_DB = split_train_dev(c.TRAIN_FEAT_VOXCELEB1_DIR, val_ratio) 
...
def main():
    ...
    # embedding_size = 128 # 128 for resnet18 and 512 for resnet50
    embedding_size = 512
    start = 1 # Start epoch
    ...
    log_dir = 'model_saved_voxceleb1_resnet50' # where to save checkpoints
